/**
 * Created by dingjiang on 24/12/2016.
 */
!
    function() {
        var e, t = function() {},
            ...
            location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function() {
                ...
                angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService",
                    function(e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y, C, v, S) {
                            ...
                            t.isLoaded = !0,
                                ...
                                s.init().then(function(n) {
                                    ...
                                    f.setUserInfo(n.User),
                                        ...
                                        d.notifyMobile(f.getUserName(), m.StatusNotifyCode_INITED),
                        ...
                        function E() {
                            t.debug && (D && o.cancel(D), C.start(4e4), D = o(function() {
                        ...
                        var k, U = $(document.body);
                        U.on("dragenter",
                            function(e) {
                                var t = e.originalEvent;
                                k = t.target,
                                    t.dataTransfer.dropEffect = "none",
                                    U.addClass("drop-enter"),
                                    t.stopPropagation(),
                                    t.preventDefault()
                            }),
                            U.on("dragleave",
                                function(e) {
                                    var t = e.originalEvent;
                                    t.dataTransfer.dropEffect = "none",
                                    k === t.target && U.removeClass("drop-enter"),
                                        t.stopPropagation(),
                                        t.preventDefault()
                                }),
                            U.on("dragover",
                ...
                function(e, t, o, n, r, a, i, c, s, l, u, f, d, m, g, p, h, M, y) {
                    ...
                    e.delState = !1,
                        ...
                        e.removeMemberFromChatroom = function(e, t) {
                            d.delMember(e, t),
                                m.close("mmpop_chatroom_members")
                        };
        ...
        function() {
            ...
            angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService",
                function(e, t, o, n, r, a, i, c, s, l, u, f, d, m, g) {
                    ...
                    function h() {
                        window.getSelection ? (I = window.getSelection(), A = I.getRangeAt(0)) : A = document.selection.createRange()
                    }
                    function M() {
                        A ? window.getSelection ? (I.removeAllRanges(), I.addRange(A)) : A.select() : y()
                    }
                    function y() {
                        var e, t;
                    ...
                    function C(e) {
                        ...
                        t.rangeCount > 0 && (o = t.getRangeAt(0).cloneRange(), o.collapse(!0), o.setStart(D, 0), n = o.toString().slice( - e));
                    ...
                    function v(e, t) {
                        var o, n;
                        if (t || M(), window.getSelection) { ! t && A ? (o = I, n = A) : (o = window.getSelection(), n = o.getRangeAt(0)),
                            n.deleteContents();
                            var r;
                        ...
                        } else n = t || !A ? document.selection.createRange() : A,
                            e = e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;"),
                            n.pasteHTML(e),
                            n.select()
                    }
                    function S() {
                        window.getSelection && (window.getSelection().getRangeAt(0).insertNode(F), k = F.offsetLeft, U = F.offsetTop - D.scrollTop, R.appendChild(F))
                    }
                    function w(t) {
                        var o = r.open({
                                    ...
                                    H = e.create({
                                        ...
                                        function(e) {
                                            ...
                                            if (0 == e.size) return H.skipFile(e),
                                                ...
                                                !1;
                                            if (e._data = e._data || {},
                                                    /untitled\d+.png/i.test(e.name)) N(e, Q),
                                                e.ToUserName = s.getCurrentUserName();
                                            else if (e.ToUserName || (e.ToUserName = s.getSendFileUsername()), N(e, z), "gif" !== e.ext.toLowerCase() && !T(e.ext)) {
                                                var n = E(e.ext);
                                                if (n == a.MSGTYPE_VIDEO && e.size >= 1024 * j * 1024) return H.skipFile(e),
                                            ...
                                            return H.md5File(e).then(function(t) {
                                                function n(e, t, o) {
                                                    ...
                                                    e._uploadParams = s,
                                                        ...
                                                        t ? (H.trigger("fileQueued", e), H.trigger("uploadSuccess", e, o), H.skipFile(e)) : (e._checked = !0, H.addFiles(e))
                                                }
                                                ...
                                                if (r) {
                                                    ...
                                                    f = angular.extend({},
                                                        ...
                                                        o({
                                                            ...
                                                            }), e.Signature = t.Signature, n(e, t.MediaId, t)) : (e.MMSendMsg && (e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL, e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL), alert(t.BaseResponse.ErrMsg))
                                                        }).error(function() {
                                                            e.MMSendMsg && (e.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_FAIL, e.MMSendMsg.MMStatus = a.MSG_SEND_STATUS_FAIL),
                                                                alert("上传失败")
                                                        })
                                                } else f = angular.extend({},
                                                    d),
                                                    n(e)
                                            }),
                                                !1
                    ...
                    var I, A, F = document.getElementById("caretPosHelper"),
                        k = 0,
                        U = 0,
                    ...
                    var H, j = 20,
                        ...
                        z = {
                                    ...
                                    this.MMSendMsg = s.createMessage({
                                        ...
                                        function(t) {
                                            t.MMSendMsg.MMThumbSrc = "",
                                                H.makeThumb(t,
                                                    function(o, n) { (o || !n) && g.report(g.ReportType.uploaderError, {
                                                        text: "创建缩略图失败",
                            ...
                            onProgress: function(e) {
                                var o = this;
                                t.$apply(function() {
                                    o.MMSendMsg && (o.MMSendMsg.MMFileStatus = a.MM_SEND_FILE_STATUS_SENDING, o.MMSendMsg.MMUploadProgress = parseInt(100 * e))
                                })
                            },
                    ...
                    function h(o, n, s, l, d) {
                        ...
                        switch ( + n) {
                            case a.MSGTYPE_TEXT:
                                ...
                                p = y ? y + ":" + g.MMActualContent: g.MMActualContent,
                                    p = p.replace(":", ": "),
                                    t.contextMenuList.push({
                        ...
                        service = {
                            ...
                            _sendCheck: function(e) {
                                var t = $("#chatArea .title_wrap .title_name")[0],
                                    o = $("#J_NavChatScrollBody")[0];
                                if (t && o) {
                                    var n = $(t),
                                        r = $(o),
                                        a = n.attr("data-username"),
                                        i = r.attr("data-username");
                                    return a && i || utilFactory.reportSendState("sendcheckAttrError"),
                                    e || utilFactory.reportSendState("toUserNameNotFound"),
                                        a == i && i == e ? !0 : (i != e && utilFactory.reportSendState("toUserNameConflictNav"), a != e && utilFactory.reportSendState("toUserNameConflictChat"), utilFactory.reportSendState("uiCheckFail"), reportService.report(reportService.ReportType.sendError, {
                                            type: "uiCheckFail",
                                ...
                                o || utilFactory.reportSendState("navcurrentNameNotFound"),
            ...
            angular.module("Services").factory("accountFactory", ["$q", "confFactory", "utilFactory",
                function(e, t, o) {
                    var n, r, a, i = {},
                        ...
                        u = "" === o.getCookie("MM_WX_NOTIFY_STATE") ? t.MM_NOTIFY_OPEN: o.getCookie("MM_WX_NOTIFY_STATE"),
                        f = "" === o.getCookie("MM_WX_SOUND_STATE") ? t.MM_SOUND_OPEN: o.getCookie("MM_WX_SOUND_STATE"),
                        d = {
                            openNotify: function() {
                                u = t.MM_NOTIFY_OPEN,
                            ...
                            getFormateSyncCheckKey: function() {
                                for (var e = s || this.getSyncKey(), t = e.List, o = [], n = 0, r = t.length; r > n; n++) o.push(t[n].Key + "_" + t[n].Val);
                                return o.join("|")
                            },
                    ...
                    var d, m = window._contacts = {},
                        ...
                        P = {
                            ...
                            getMemberDisplayName: function(e) {
                                return I.getChatroomIdByUserName(e),
                        ...
                        I = {
                            ...
                            batchGetContact: function(e) {
                                var n = o.defer(),
                                    i = 1;
                                return w.length ? (i = w.length < 6 || E > 2 ? 1 : w.length < 40 ? 5 : 10, S = w.splice(0, i), console.log("_contactsWithErrorToGetList lenght:", w.length)) : S = v.splice(0, 50),
                                    t({
                                        method: "POST",
                            ...
                            getAllFriendContact: function(e) {
                                ...
                                for (var o in m) if (!e.filterContacts[o]) {
                                    var n = m[o];
                    ...
                    var u = {
                        ...
                        reportSendState: function(e, t) {
                            var o = 63637,
                                ...
                                a = r[e];
                            a && this.reportIdkey(o, a[n ? "ie": "notIe"], t)
                        },
                        reportIdkey: function(e, t, o) {
                            var n = "https://support.weixin.qq.com/cgi-bin/mmsupport-bin/reportforweb?rid=" + e + "&rkey=" + t + "&rvalue=" + (o || 1); (new Image).src = n
                        },
                        isUserName: function() {},
        ...
        function() {
            ...
            angular.module("Services").factory("notificationFactory", ["utilFactory",
                function(e) {
                    ...
                    function r() {
                        var e;
                        return g ? (window.Notification && window.Notification.permissionLevel ? e = window.Notification.permissionLevel() : window.webkitNotifications && window.webkitNotifications.checkPermission ? e = f[window.webkitNotifications.checkPermission()] : window.Notification && window.Notification.permission ? e = window.Notification.permission: navigator.mozNotification ? e = l: window.external && void 0 !== window.external.msIsSiteMode() && (e = window.external.msIsSiteMode() ? l: s), e) : void 0
                    }
                    function a(e) {
                    ...
                    function c(e, n) {
                        ...
                        var a, c;
                        return g && i() && angular.isString(e) && n && (angular.isString(n.icon) || angular.isObject(n.icon)) && r() === l && (a = t(e, n)),
                            c = o(a),
                            h.push(c),
                    ...
                    var p = a.find("body"),
                        h = {
                            ...
                            performClosePop: function(e, t) {
                                var o = e.attr("id"),
                                    i = e.scope();
                                i && !i.closing && (i.closing = !0, e.unbind("click"), 1 === n && p.unbind("keydown"), u.$broadcast("root:mmpop:closing", o), g.leave(e,
                                    function() {
                        ...
                        M = {
                            open: function(l) {
                                ...
                                return w = y.container ? y.container: p,
                                    ...
                                    g.enter(S, w),
                                y.autoFoucs && S.focus(),
                                y.controller && (angular.isString(y.controller) || angular.isArray(y.controller) || angular.isFunction(y.controller)) && m(y.controller, {
                                    $scope: v,
                                    $element: S
                                }),
                                ...
                                s && clearTimeout(s),
                                    s = setTimeout(function() {
                                            ...
                                            if ( - 1 != l && -1 != u) {
                                                if (u = d - 1 - u, l >= u) {
                                                    f = l;
                                                    for (var m = r.substr(f + 1, 10); ++f < d;) if (m == c.substr(f, m.length)) {
                                                        u = f;
                                                        break
                                                    }
                                                    f == d && (u = d - 1)
                                                ...
                                                var _ = i(g).replace(/&nbsp;/g, " ").replace(new RegExp("<(?!br|" + o.EMOTICON_REG + ").*?>", "g"), "").replace(new RegExp("&lt;(br|" + o.EMOTICON_REG + "/?)&gt;", "g"), "<$1>").replace(/<img.*?class="(.*?)" text="(.*?)" .*?>/g,
                                                    function() {
                                                ...
                                                w && (document.createRange ? (v = document.createRange(), v.setStartAfter(w), v.collapse(!1), S = window.getSelection(), S.removeAllRanges(), S.addRange(v)) : document.selection && (v = document.body.createTextRange(), v.moveToElementText(w), v.collapse(!1), v.select()), w.parentNode.removeChild(w)),
                                ...
                                var _ = {
                                    ...
                                    v = {
                                        open: function(a) {
                                            ...
                                            return m.when(c(S.template || S.templateUrl)).then(function(t) {
                                                if (f.put(S.template || S.templateUrl, t), S.showClose && (t += '<div class="ngdialog-close"></div>'), u.$result = b = o('<div id="ngdialog' + r + '" class="ngdialog"></div>'), b.html(S.overlay ? '<div class="ngdialog-overlay"></div><div class="ngdialog-content">' + t + "</div>": '<div class="ngdialog-content">' + t + "</div>"), S.data && e.isString(S.data)) {
                                                ...
                                                if (E.closeThisDialog = function(e) {
                                                        ...
                                                        }), S.closeByEscape && C.bind("keydown", _.onDocumentKeydown), S.closeByNavigation && p.$on("$locationChangeSuccess",
                                                        function() {
                                                            _.closeDialog(b)
                                                        }), n = function(e) {
                                ...
                                if (c) {
                                    switch (e.keyCode) {
                                        case o.KEYCODE_ARROW_UP:
                                            do c = c._index - 1 < 0 ? m: u[c._index - 1];
                                            while (!n(c));
                                            c == m && (r = !0);
                                            break;
                                        case o.KEYCODE_ARROW_DOWN:
                                            do c = c._index + 1 >= u.length ? m: u[c._index + 1];
                                            while (!n(c));
                                            break;
                                        default:
                                            return
    ...
    function() {
        ...
        function c(t, o) {
            ...
            for (c = 0; c < t.length; c += 16) s = d,
                ...
                u = g,
                f = p,
                d = n(d, m, g, p, t[c], 7, -680876936),
                p = n(p, d, m, g, t[c + 1], 12, -389564586),
                g = n(g, p, d, m, t[c + 2], 17, 606105819),
                m = n(m, g, p, d, t[c + 3], 22, -1044525330),
                d = n(d, m, g, p, t[c + 4], 7, -176418897),
                p = n(p, d, m, g, t[c + 5], 12, 1200080426),
                g = n(g, p, d, m, t[c + 6], 17, -1473231341),
                m = n(m, g, p, d, t[c + 7], 22, -45705983),
                d = n(d, m, g, p, t[c + 8], 7, 1770035416),
                p = n(p, d, m, g, t[c + 9], 12, -1958414417),
                g = n(g, p, d, m, t[c + 10], 17, -42063),
                m = n(m, g, p, d, t[c + 11], 22, -1990404162),
                d = n(d, m, g, p, t[c + 12], 7, 1804603682),
                p = n(p, d, m, g, t[c + 13], 12, -40341101),
                g = n(g, p, d, m, t[c + 14], 17, -1502002290),
                m = n(m, g, p, d, t[c + 15], 22, 1236535329),
                d = r(d, m, g, p, t[c + 1], 5, -165796510),
                p = r(p, d, m, g, t[c + 6], 9, -1069501632),
                g = r(g, p, d, m, t[c + 11], 14, 643717713),
                m = r(m, g, p, d, t[c], 20, -373897302),
                d = r(d, m, g, p, t[c + 5], 5, -701558691),
                p = r(p, d, m, g, t[c + 10], 9, 38016083),
                g = r(g, p, d, m, t[c + 15], 14, -660478335),
                m = r(m, g, p, d, t[c + 4], 20, -405537848),
                d = r(d, m, g, p, t[c + 9], 5, 568446438),
                p = r(p, d, m, g, t[c + 14], 9, -1019803690),
                g = r(g, p, d, m, t[c + 3], 14, -187363961),
                m = r(m, g, p, d, t[c + 8], 20, 1163531501),
                d = r(d, m, g, p, t[c + 13], 5, -1444681467),
                p = r(p, d, m, g, t[c + 2], 9, -51403784),
                g = r(g, p, d, m, t[c + 7], 14, 1735328473),
                m = r(m, g, p, d, t[c + 12], 20, -1926607734),
                d = a(d, m, g, p, t[c + 5], 4, -378558),
                p = a(p, d, m, g, t[c + 8], 11, -2022574463),
                g = a(g, p, d, m, t[c + 11], 16, 1839030562),
                m = a(m, g, p, d, t[c + 14], 23, -35309556),
                d = a(d, m, g, p, t[c + 1], 4, -1530992060),
                p = a(p, d, m, g, t[c + 4], 11, 1272893353),
                g = a(g, p, d, m, t[c + 7], 16, -155497632),
                m = a(m, g, p, d, t[c + 10], 23, -1094730640),
                d = a(d, m, g, p, t[c + 13], 4, 681279174),
                p = a(p, d, m, g, t[c], 11, -358537222),
                g = a(g, p, d, m, t[c + 3], 16, -722521979),
                m = a(m, g, p, d, t[c + 6], 23, 76029189),
                d = a(d, m, g, p, t[c + 9], 4, -640364487),
                p = a(p, d, m, g, t[c + 12], 11, -421815835),
                g = a(g, p, d, m, t[c + 15], 16, 530742520),
                m = a(m, g, p, d, t[c + 2], 23, -995338651),
                d = i(d, m, g, p, t[c], 6, -198630844),
                p = i(p, d, m, g, t[c + 7], 10, 1126891415),
                g = i(g, p, d, m, t[c + 14], 15, -1416354905),
                m = i(m, g, p, d, t[c + 5], 21, -57434055),
                d = i(d, m, g, p, t[c + 12], 6, 1700485571),
                p = i(p, d, m, g, t[c + 3], 10, -1894986606),
                g = i(g, p, d, m, t[c + 10], 15, -1051523),
                m = i(m, g, p, d, t[c + 1], 21, -2054922799),
                d = i(d, m, g, p, t[c + 8], 6, 1873313359),
                p = i(p, d, m, g, t[c + 15], 10, -30611744),
                g = i(g, p, d, m, t[c + 6], 15, -1560198380),
                m = i(m, g, p, d, t[c + 13], 21, 1309151649),
                d = i(d, m, g, p, t[c + 4], 6, -145523070),
                p = i(p, d, m, g, t[c + 11], 10, -1120210379),
                g = i(g, p, d, m, t[c + 2], 15, 718787259),
                m = i(m, g, p, d, t[c + 9], 21, -343485551),
                d = e(d, s),
                m = e(m, l),
                g = e(g, u),
                p = e(p, f);
