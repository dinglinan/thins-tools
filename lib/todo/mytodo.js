...
jQuery(document).ready(function($){
    ...
    /* mytodo.js:21 EvalError: Refused to evaluate a string as JavaScript because 'unsafe-eval' is not an allowed source of script in the following Content Security Policy directive: "script-src 'self' blob: filesystem: chrome-extension-resource:".(…)(anonymous function) @ mytodo.js:21 */
    /*// 加载模版
    var tpls = $.tpls = {};
    try{
